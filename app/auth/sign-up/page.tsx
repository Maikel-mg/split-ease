...
export default function SignUpPage() {
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      setError(error instanceof Error ? error.message : "No se pudo registrar con Google")
      setIsLoading(false)
    }
  }
  ...
  return (
    <main className="flex min-h-screen w-full items-center justify-center bg-background p-6">
      <div className="w-full max-w-sm">
        <p className="mb-8 text-sm font-bold tracking-tight text-ink-2">GastoGrupal</p>

        <div className="mb-6 space-y-1">
          <h1 className="text-2xl font-bold tracking-tight">Crear cuenta</h1>
          <p className="text-sm text-ink-2">Con una cuenta puedes crear grupos y unirte a los tuyos.</p>
        </div>
        ...
        <form onSubmit={handleSignUp} className="space-y-5">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="bg-background px-2 text-ink-2">o</span>
            </div>
          </div>
